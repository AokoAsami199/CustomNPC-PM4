...
use pocketmine\utils\{Utils, Config, TextFormat as COLOR};
...
class NPC extends PluginBase
{
    ...
    public static $emotes = [ # Didn't take too much to sort this, code is here (https://3v4l.org/Eh0vj)
    ...
    public function onEnable(): void
    {
        ...
        EntityFactory::getInstance()->register(CustomNPC::class, function(World $world, CompoundTag $nbt): Entity
        {
    ...
    {
        $NBT = CompoundTag::create($player, $player->getMotion(), $player->getLocation()->getYaw(), $player->getLocation()->getPitch());
        $NPC = new CustomNPC($player->getLocation(), $player->getSkin());
